            ...
            public void itemStateChanged(ItemEvent e) {
                ...
                try{
                    switch (item){
                        ...
                        case "Nagad":
                            new PanelHolderFrame().add(new NagadPanel());System.out.println(item);
                            break;

                        case "Rocket":
                            new PanelHolderFrame().add(new RocketPanel());System.out.println(item);
                            break;

                        case "uKash":
                            new PanelHolderFrame().add(new uKashPanel());System.out.println(item);
                            break;
                        case "sure kash":
                            new PanelHolderFrame().add(new SureKashPanel());System.out.println(item);
                            break;
                        default:
                            break;
                    }
